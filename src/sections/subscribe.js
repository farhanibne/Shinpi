...
const Subscribe = () => {
  return (
    <Box as="section" sx={styles.subscribe}>
      <Container>
        <Heading as="h3">Apply to join</Heading>
        <Text as="p">
          By applying with your mail, you will accept our privacy policy
        </Text>
        <Box as="form" sx={styles.form}>
          ...
          <a style={{textDecoration:'none',color:'black'}} target={"_blank"} href={"mailto: info.shinpi@gmail.com"}>
            Apply
          </a>
